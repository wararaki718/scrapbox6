...
class SearchClient:
    ...
    def get_version(self) -> str:
        response = httpx.get(self._client._client.rest_uri).json()
    ...
    def download_snapshot(self, collection_name: str, snapshot_name: str, filepath: Path, chunk_size: int=8192) -> bool:
