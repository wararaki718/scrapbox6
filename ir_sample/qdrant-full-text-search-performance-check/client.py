...
from qdrant_client.http.models import PointStruct, ScoredPoint, TextIndexParams, TokenizerType, UpdateResult, VectorParams
...
class SearchClient:
    ...
    def create_payload_index(self, collection_name: str, field_name: str) -> UpdateResult:
